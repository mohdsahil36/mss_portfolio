...
export default function Skills({
  ...
  return (
    <motion.section
      ref={ref}
      id="skills"
      className="mt-4 scroll-mt-18 bg-white py-8 text-[#151719] dark:bg-neutral-950 dark:text-white"
