  ...
  return (
    ...
    >
      <div className="mb-6 border-b border-[#ededed] pb-4 dark:border-zinc-800">
        ...
        <p className="mt-2 max-w-[31rem] text-[0.78rem] font-medium leading-6 text-[#747780] dark:text-zinc-400">
          {impactSection.summary}
        </p>
      </div>

      <div className="rounded-[1.35rem] border border-[#e8e8e8] bg-white px-4 dark:border-zinc-800 dark:bg-background sm:px-5">
        {impactMetrics.map((metric, index) => {
          ...
          return (
            <motion.article
              ...
              className="group grid gap-3 border-b border-[#eeeeee] py-4 last:border-b-0 sm:grid-cols-[5rem_1fr] dark:border-zinc-800"
            >
              <div className="flex items-center gap-2.5">
                ...
                <p className="font-mono text-[1.08rem] font-semibold leading-none tabular-nums text-[#151719] dark:text-white">
                  {metric.value}
                </p>
              </div>
